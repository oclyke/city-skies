...
mp_obj_t global_pixel(size_t n_args, const mp_obj_t *args) {
  ...
  ret = sicgl_global_pixel(&self->interface, mp_obj_get_int(args[ARG_color]), u, v);
  if (0 != ret) {
    mp_raise_OSError(ret);
  }
...
mp_obj_t global_line(size_t n_args, const mp_obj_t *args) {
  ...
  ret = sicgl_global_line(&self->interface, mp_obj_get_int(args[ARG_color]), u0, v0, u1, v1);
  if (0 != ret) {
    mp_raise_OSError(ret);
  }
  return mp_const_none;
...
mp_obj_t global_rectangle(size_t n_args, const mp_obj_t *args) {
  ...
  ret = sicgl_global_rectangle(&self->interface, mp_obj_get_int(args[ARG_color]), u0, v0, u1, v1);
  if (0 != ret) {
    mp_raise_OSError(ret);
  }
  return mp_const_none;
...
mp_obj_t global_circle(size_t n_args, const mp_obj_t *args) {
  ...
  ret = sicgl_global_circle_ellipse(&self->interface, mp_obj_get_int(args[ARG_color]), u0, v0, mp_obj_get_int(args[ARG_diameter]));
  if (0 != ret) {
    mp_raise_OSError(ret);
  }
  return mp_const_none;
...
mp_obj_t global_ellipse(size_t n_args, const mp_obj_t *args) {
  ...
  ret = sicgl_global_ellipse(&self->interface, mp_obj_get_int(args[ARG_color]), u0, v0, semiu, semiv);
  if (0 != ret) {
    mp_raise_OSError(ret);
  }
  return mp_const_none;
