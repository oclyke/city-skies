...
// drawing methods
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(interface_pixel_obj, 3, 3, interface_pixel);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(interface_line_obj, 4, 4, interface_line);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(interface_rectangle_obj, 4, 4, interface_rectangle);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(interface_circle_obj, 4, 4, interface_circle);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(interface_ellipse_obj, 4, 4, interface_ellipse);

STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(global_pixel_obj, 3, 3, global_pixel);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(global_line_obj, 4, 4, global_line);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(global_rectangle_obj, 4, 4, global_rectangle);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(global_circle_obj, 4, 4, global_circle);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(global_ellipse_obj, 4, 4, global_ellipse);

STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(screen_pixel_obj, 4, 4, screen_pixel);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(screen_line_obj, 5, 5, screen_line);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(screen_rectangle_obj, 5, 5, screen_rectangle);
...
STATIC const mp_rom_map_elem_t locals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_interface_rectangle), MP_ROM_PTR(&interface_rectangle_obj)},
    {MP_ROM_QSTR(MP_QSTR_interface_circle), MP_ROM_PTR(&interface_circle_obj)},
    {MP_ROM_QSTR(MP_QSTR_interface_ellipse), MP_ROM_PTR(&interface_ellipse_obj)},
